...
from networks.panoramic_resnet import ResNet, BasicBlock, Bottleneck, resnet18, resnet34, resnet50, resnet101, \
...
def resnet_multiimage_input(conv_layer, num_layers, pretrained=False, num_input_images=1):
    ...
    model = ResNetMultiImageInput(conv_layer, block_type, blocks, num_input_images=num_input_images)
...
class ResnetEncoder(nn.Module):
    ...
    """
    def __init__(self, conv_layer, num_layers, pretrained, num_input_images=1):
        ...
        if num_input_images > 1:
            self.encoder = resnet_multiimage_input(conv_layer, num_layers, pretrained, num_input_images)
        else:
            self.encoder = resnets[num_layers](conv_layer, pretrained)
